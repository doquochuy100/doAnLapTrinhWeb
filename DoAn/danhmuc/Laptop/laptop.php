...
<div class="container">
  <div class="row" >
    <div class="col-2">
      <a href="http://doquochuy.cf/DoAn/danhmuc/main/danhmuc.php"> <img src="http://doquochuy.cf/DoAn/Demo/images/Logo.png" width="180px" height="80px" alt=""></a>
    </div>
    <div class="col-10">
      <div class="row">
        <div class="col-6">
  ...
  <table class="table table-bordered">
    ...
    <?php foreach($data as $key => $value){?>
			...
			<td class="product-data">
                <a href="#"><img src="http://doquochuy.cf/DoAn/sanpham/img/<?php echo $value['hinh'] ?> "style="max-width: 300px;"> </a>
