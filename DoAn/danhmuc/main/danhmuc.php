...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="http://doquochuy.cf/DoAn/danhmuc/main/styleDanhmuc.css" rel="stylesheet">
    <meta name="viewport" content="width=device-width, initial-scale=1">
...
<div class="container">
  <div class="row" >
    <div class="col-2">
      <a href="http://doquochuy.cf"> <img src="http://doquochuy.cf/DoAn/Demo/images/Logo.png" width="180px" height="80px" alt=""></a>
    </div>
    <div class="col-10">
      <div class="row">
        <div class="col-6">
        ...
        <div class="mng-btn col-6">
          ...
          <button type="button"class="btn btn-dark">
            <a href="http://doquochuy.cf/DoAn/account/tkKhachHang.php">INFO</a>
          </button>
          <button type="button"class="btn btn-dark">
            <a href="http://doquochuy.cf/DoAn/giohang/gioHang.php">CART</a>
          </button>
    ...
    <ul>
      <li><a href=""><span class="fa fa-laptop"></span>Laptop</a>
        <ul>
          ...
          <li><?php echo" <a href='http://doquochuy.cf/DoAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$dell '> <span class='fa fa-laptop'></span>Laptop Dell</a>"?></li>
          <li><?php echo" <a href='http://doquochuy.cf/DoAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$hp '> <span class='fa fa-laptop'></span>Laptop HP</a>"?></li>
         <li><?php echo" <a href='http://doquochuy.cf/DoAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$acer '> <span class='fa fa-laptop'></span>Laptop Acer</a>"?></li>
          <li><?php echo" <a href='http://doquochuy.cf/DoAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$msi '> <span class='fa fa-laptop'></span>Laptop MSI</a>"?></li>
          <li><?php echo" <a href='http://doquochuy.cf/DoAn/danhmuc/Laptop/laptop.php?id=$lt&tennsx=$asus '> <span class='fa fa-laptop'></span>Laptop Asus</a>"?></li>
        </ul>
      </li>
...
<div class="mySlides fade">
  <img src="http://doquochuy.cf/DoAn/Demo/images/pcgamingslide1.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <img src="http://doquochuy.cf/DoAn/Demo/images/keyboardgamingslide2.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <img src="http://doquochuy.cf/DoAn/Demo/images/casegamingslide3.jpg" style="width:100%">
  <div class="text"></div>
</div>
    ...
    if(isset($_POST['tukhoa'])) {
        ...
        <table class="table table-bordered" style="text-align: center;">
          ...
          <td class="product-data">
              <a href="chitietsp.php?action=them&id=<?php echo $value['masp'];?>"><img src="http://doquochuy.cf/DoAn/sanpham/img/<?php echo $value['hinh'] ?> "style="max-width: 300px;"> </a>
